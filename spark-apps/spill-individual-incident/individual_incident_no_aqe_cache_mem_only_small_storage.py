...
APP_NAME = f"(Cache - Memory Only - No AQE - 500m - Small Storage Fraction.) {__file__}"

spark_conf = SparkConf().setAppName(APP_NAME)\
    .set("spark.executor.memory", "450m")\
    .set("spark.memory.fraction", 0.60)\
    .set("spark.memory.storageFraction", 0.10)\
...
def main():
    ...
    # make submit app=spill-individual-incident/individual_incident_no_aqe_cache_mem_only_small_storage.py
    #
    ...
    df_input.persist(StorageLevel.MEMORY_ONLY)
