...
APP_NAME = f"(Spill) Solution 2: increase number of partitions and spark.memory.fraction  - {__file__}"
...
def main():
    ...
    # make submit app=spill-individual-incident/individual_incident_spill_solution_2b.py
    #
