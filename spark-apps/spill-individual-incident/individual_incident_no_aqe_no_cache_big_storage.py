...
APP_NAME = f"(No Cache - No AQE - 450m - Big Storage Fraction.) {__file__}"

spark_conf = SparkConf().setAppName(APP_NAME)\
    .set("spark.executor.memory", "450m")\
    .set("spark.memory.fraction", 0.60)\
    .set("spark.memory.storageFraction", 0.80)\
...
def main():
    ...
    # make submit app=spill-individual-incident/individual_incident_no_aqe_no_cache_big_storage.py
    #
