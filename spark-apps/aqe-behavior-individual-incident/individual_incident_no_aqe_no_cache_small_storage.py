...
APP_NAME = f"(No Cache - No AQE - 450m - Small Storage Fraction.) {__file__}"
...
def main():
    ...
    # make submit app=spill-individual-incident/individual_incident_no_aqe_no_cache_small_storage.py
    #
